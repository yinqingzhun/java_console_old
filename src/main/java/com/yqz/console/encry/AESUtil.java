...
//        System.out.println("MaxAllowedKeyLength: " + Cipher.getMaxAllowedKeyLength("AES"));
//        String pwd = "abc";
//        String source = "hi";
//        pwd = "ap)Encrypt{Autohome}com>cn'+Live";
//        //     pwd = "1234567890123456111";
//
////        String cipherMode = "AES/ECB/PKCS5Padding";
        String cipherMode = "AES/ECB/PKCS7Padding";
//        String encryptText = encryptHex(cipherMode, source, pwd);
//        System.out.println(encryptText);
//
//        encryptText = "";
//
////        System.out.println(decryptHex(cipherMode, encryptText, pwd));
//
//        source = decryptBase64(cipherMode, encryptText, pwd);
//        System.out.println(source);
//
//        encryptText = encryptBase64(cipherMode, source, pwd);
//        System.out.println(encryptText);
//
//        source = decryptBase64(cipherMode, encryptText, pwd);
//        System.out.println(source);
  ...
  /*      Map<String, String> testMap = new HashMap() {
            {
                put("live.open.jkxi", "7jC2^t%^36");
                put("live.open.jkxa", "tNI6*B4DDy");
                put("live.open.jkxiz", "J0$P&zE2mN");
                put("live.open.jkxaz", "RLj@6x#55v");
                put("live.intranet.jkx", "$dJ1#$yda*");
            }
        };*/

        Map<String, String> onlineMap = new HashMap() {
            {
                put("live.online.jkx.i", "i%gt%3guvE");
                put("live.online.jkx.a", "I0$TMinYag");
                put("live.online.jkx.iz", "08mMdQE1o#");
                put("live.online.jkx.az", "aML$E!rH8E");
                put("live.online.jkx.n", "A4*aVT%LeP");
            }
        };

        /*Map<String, String> testMap = new HashMap() {
            {
                put("live.open.jkx.i", "vLJpdfOz3(");
//                put("live.open.jkx.a", "Ot)!12rAB_");
                put("live.open.jkx.iz", "r(^*e1FUvo");
//                put("live.open.jkx.az", "Ryk(B#GD^F");
//                put("live.intranet.jkx", "L41jq6ZYPf");
            }
        };*/



     final String   p = "cZJ06L#ciPau^A!R";
        onlineMap.entrySet().stream().forEach(entry -> {
            System.out.println(entry.getKey() + "--->" + AESUtil.encryptHex(cipherMode, entry.getValue(), p));
        });
