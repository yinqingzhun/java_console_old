...
public class Exchange implements Runnable {
    //match orders
    public static com.yqz.console.tech.stock.LinkedList buyList;
    public static com.yqz.console.tech.stock.LinkedList sellList;
    com.yqz.console.tech.stock.LinkedList buffer;
    int profit;
    long startT;
    Order a;
    ...
    Exchange(long start) {
        startT = start;
        profit = 0;
        buyList = new com.yqz.console.tech.stock.LinkedList();
        sellList = new com.yqz.console.tech.stock.LinkedList();
    ...
    private void print(String log, double time, int status, Order a) {
        try {
            ...
            if (a.type)
                System.out.println(log + " " + time + " " + status + " " + a.inTime + " " + a.name + " " + a.expTime + " sell " + a.qty + " " + a.stock + " " + a.price + " " + a.partial);
            else
                System.out.println(log + " " + time + " " + status + " " + a.inTime + " " + a.name + " " + a.expTime + " buy " + a.qty + " " + a.stock + " " + a.price + " " + a.partial);
