...
import com.yqz.console.tech.model.FeedBase;
import com.yqz.console.tech.utils.DateHelper;
import com.yqz.console.tech.utils.HashHelper;
import com.yqz.console.tech.utils.JsonHelper;
...
//        System.out.println(String.format("{%s}:ut:%s", uid, token) + "---" + result.getT2());
    ...
    public static void addBlacklist() {
        ...
        System.out.println(url);
        HttpHelper.HttpResult result = HttpHelper.httpGet(url);
...
//                    log.info(url);
                    HttpHelper.HttpResult result = HttpHelper.httpGet(url);
                    System.out.println(DateHelper.getNowString(DateHelper.DATEFORMAT_FULL) + "/t" + result.getBody());
                    if (result.getStatusCode() == 200) {
                        JsonNode jsonNode = JsonHelper.deserialize(result.getBody(), JsonNode.class);
...
//        //debug
    ...
    private static void viewPage() {
        ...
        headers.put("Cookie", "JSESSIONID=3E25DDE23F889141DD4A6A33D73619C9; uid_ops=1c5561f07e0633517329d9725109a81e; Hm_lvt_55e5bc85dd8a87269602a46292299046=1587952289; Hm_lpvt_55e5bc85dd8a87269602a46292299046=1587968393");


        HttpHelper.HttpResult result = HttpHelper.httpGet("http://ops.networkbench.com/ops/taskMgrTemp.do?formAction=list", null, headers);

        System.out.printf("code: %s, body: %s", result.getStatusCode(), result.getBody());
